...
namespace ServoTool
{
    public partial class ServoTool : Form
    {
        ...
        private void Btn_FrqResStart_Click(object sender, EventArgs e)
        {
            ...
            path.Filter = "CSV(逗號分隔)|*.frq";
            if (path.ShowDialog() == System.Windows.Forms.DialogResult.OK && path.FileName != "")
            {
                Smplsw = new StreamWriter(path.FileName);
                TB_ConStatus.Text = "Disturbance input...";
                sbyte[] Axis = new sbyte[3] { (sbyte)(CB_FrqAxis.SelectedIndex + 1), (sbyte)(CB_FrqAxis.SelectedIndex + 1), (sbyte)(CB_FrqAxis.SelectedIndex + 1) };
                short[] Type = new short[3] { 3, 32, 31 };
                string ret = Itri2Fanuc.SamplingStart( 3, Axis, Type, 512, -1, 0);
                if (ret.Equals("EW_OK"))
                {
                    ret = mts.FrqResponseStart((short)(CB_FrqAxis.SelectedIndex + 1), (int)(NumUpDown_FrqStart.Value),
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            {
                SmplStat = Itri2Fanuc.SamplingEnd();
        ...
        private void Btn_FrqResEnd_Click(object sender, EventArgs e)
        {
            ...
            string ret = mts.FrqResponseEnd(1);
